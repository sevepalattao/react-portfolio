...
export default function About() {
    return (
        <section className='sections'>
            ...
            <p>
                Hello! Welcome to my Portfolio Page! My name is Seve Palattao. I am originally
                from Minneapolis, Minnesota and I currently live in Chicago, Illinois. I am a
                recent college graduate from the class of 2022 at the University of Minnesota.
                ...
                I look forward to learning new skills and seeing what opportunities the future holds!
            </p>
            </div>
          </div>
        </section>
